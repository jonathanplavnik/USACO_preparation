...
public class acslcontest2final {
    ...
    public static String encodeMessage(String text, String message) {
        ...
        for(int i = 0; i < text.length()-1; i++){
            ...
            // }
            if(i > 0){
                if(index.keySet().contains(text.charAt(i-1)) && !index.keySet().contains(x)){
                    w++;
                    c = 0;
                } 
            }
        ...
        // ArrayList<info> its = index.get('l');
        // for(int i = 0; i < its.size(); i++){
        //     System.out.println(its.get(i).toString());
        // }
